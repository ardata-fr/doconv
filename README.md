...
- Package [docxtractr](https://CRAN.R-project.org/package=docxtractr)
  provides `convert_to_pdf()`, which works very well. The functionality
  integrated in Bob Rudis’ package depends only on ‘LibreOffice’.
