...
Some functions are provided to visual-test documents, format 'doc', 'docx', 'ppt', 'pptx', 'html' and 'png' are supported. The functions can be used with packages 
"testthat" and package "tinytest".

In order to work, the package 
